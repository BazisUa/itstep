...
class Human:
    ...
    def shopping(self, manage) -> object:
        if self.car.drive():
            pass
        else:
            if self.car.fuel < 20:
    ...
    def days_indexes(self, day):
        ...
        cat_indexes = f"{self.cat.cat} cat indexes"
        print(f"{cat_indexes:^50}", "\n")
        print(f"Breed - {self.cat.cat}")
        print(f"Gladness - {self.cat.cat_gladness}")
    ...
    def live(self, day):
        ...
        if self.cat is None:
            self.get_cat()
            print(f"I don't have a cat, I'm going to get a cat {self.cat.cat}")
...
class Cat:
    def __init__(self, cat_list):
        ...
        self.cat_gladness = cat_list[self.cat]["gladness"]
        self.cat_satiety = 30
