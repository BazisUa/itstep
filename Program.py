...
def registration():
    ...
    button_rr = Button(frame, text="Настройки", bg="White", command=lambda: webbrowser.open('https://www.youtube.com/watch?v=dQw4w9WgXcQ', new=2))
    button_rr.place(relheight=0.1, relwidth=0.3, relx=0.001, rely=0.9)
